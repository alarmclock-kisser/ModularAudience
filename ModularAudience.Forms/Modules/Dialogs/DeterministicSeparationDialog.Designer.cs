namespace ModularAudience.Forms
{
    partial class DeterministicSeparationDialog
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tabPage_advancedDsp.Text = "Advanced DSP";
            ...
            this.checkBox_cqtAnalysis.Enabled = true;
            ...
            this.toolTip_settings.SetToolTip(this.domainUpDown_cqtBinsPerOctave, "Constant-Q bins per octave: 12, 24 or 36. CQT evidence relates component activations to constant-Q envelopes.");
            ...
            this.numeric_cqtMinimumHz.Enabled = true;
            ...
            this.checkBox_cqtSynthesis.Text = "CQT synthesis";
            this.toolTip_settings.SetToolTip(this.checkBox_cqtSynthesis, "Invertible CQT/NSGT outer-OLA slice renderer. Uses original level/channel phase; Residual remains final mixture difference. Not compatible with ILRMA.");
            this.checkBox_pyin.Anchor = AnchorStyles.Left;
            this.checkBox_pyin.AutoSize = true;
            this.checkBox_pyin.Enabled = true;
            this.checkBox_pyin.Margin = new Padding(3, 9, 8, 0);
            this.checkBox_pyin.Name = "checkBox_pyin";
            this.checkBox_pyin.Text = "pYIN pitch evidence";
            this.toolTip_settings.SetToolTip(this.checkBox_pyin, "Probabilistic YIN/HMM/Viterbi monophonic pitch tracking. Voiced evidence and pitch compatibility affect grouping/profile assignment. Monophonic only.");
            ...
            this.numeric_pyinMinimumHz.Enabled = true;
            ...
            this.numeric_pyinMaximumHz.Enabled = true;
            ...
            this.checkBox_ilrma.Text = "Stereo ILRMA";
            this.toolTip_settings.SetToolTip(this.checkBox_ilrma, "Two-microphone ILRMA spatial demixing. Requires stereo input. Maximum two instrument profiles. Not compatible with CQT synthesis.");
            ...
            this.numeric_ilrmaIterations.Enabled = true;
            ...
            this.numeric_ilrmaComponents.Enabled = true;
            ...
            this.label_advancedPending.Text = "CQT analysis adds constant-Q evidence to component measurement. CQT synthesis uses invertible NSGT outer-OLA. pYIN provides monophonic pitch tracking. Stereo ILRMA requires two-microphone input, rejects >2 profiles and CQT synthesis.";
            //
            // Settings layout
            //
            ...
            this.numeric_pyinMinimumHz.ValueChanged += this.settings_ValueChanged;
            this.numeric_pyinMinimumHz.TextChanged += this.settings_ValueChanged;
            this.numeric_pyinMaximumHz.ValueChanged += this.settings_ValueChanged;
            this.numeric_pyinMaximumHz.TextChanged += this.settings_ValueChanged;
            this.numeric_ilrmaIterations.ValueChanged += this.settings_ValueChanged;
            this.numeric_ilrmaIterations.TextChanged += this.settings_ValueChanged;
